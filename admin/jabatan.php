      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                   <div class="form-group">
                       <center><img src="file/pangkat.jpeg" width="80%"></center>
                     </div>
                </div>
          ...
          <div class="col-md-6">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title"><b>Tambah Riwayat Pangkat</b></h3>
                </div>
                <div class="card-body">
                  <div class="form-group">
                     <form action="t_pangkat.php" method="POST">
          ...
          <div class="col-md-6">
            <div class="card card-default">
                <div class="card-header">
                  <h3 class="card-title"><b>Tambah Riwayat Jabatan</b></h3>
                </div>
                <div class="card-body">
                   
                   <div class="form-group">
                    <form action="t_jabat.php" method="POST">
                      <label>Nama:</label>
                        <div class="input-group my-colorpicker2">
          ...
          <div class="col-md-6">
            <div class="card card-default">
                ...
                <div class="card-body">
                  <center><img src="file/jabatan.jpg" width="100%"></center>
